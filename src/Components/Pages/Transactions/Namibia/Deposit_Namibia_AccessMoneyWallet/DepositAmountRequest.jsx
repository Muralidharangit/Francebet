...
import {
  sendDepositRequestNamibiaAccessMoneyWallet,
  sendDepositRequestNamibiaNedBankWallet,
} from "../../../../../API/depositAPI";
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting, setErrors, resetForm }) => {
      try {
        ...
        const response = await sendDepositRequestNamibiaAccessMoneyWallet({
          token,
          ...
          <div className="modal-dialog modal-dialog-centered modal-sm justify-content-center">
            <div className="modal-content" style={{ width: "220px" }}>
              <div className="modal-body d-flex flex-column align-items-center">
                ...
                <Link to={routes.transactions.access_money_wallet_history}>
                  <span
