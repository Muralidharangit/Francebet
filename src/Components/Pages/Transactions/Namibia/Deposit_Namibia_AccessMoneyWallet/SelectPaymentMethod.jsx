...
import { getDepositMethodsNamibiaAccessMoneywallet } from "../../../../../API/depositAPI";
...
const SelectPaymentMethod = ({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setError(null);
      try {
        const res = await getDepositMethodsNamibiaAccessMoneywallet(token);
          ...
          <div className="card account_input-textbox-container border-0">
            <div className="card-body pt-0 py-0">
              ...
              <small className="text-muted">
                After transfer, upload the payment screenshot and reference/UTR
